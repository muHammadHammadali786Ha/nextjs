...
import { z } from 'zod';
import { FiUser, FiMail, FiLock, FiSmartphone, FiArrowRight } from 'react-icons/fi';
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-gray-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-white rounded-xl shadow-lg overflow-hidden">
        ...
        <div className="bg-gradient-to-r from-blue-600 to-indigo-700 p-6 text-center">
          ...
          <p className="text-blue-100 mt-1">Join SmartIntern today</p>
        </div>

        {/* Form */}
        <form className="p-6 space-y-4" onSubmit={onSubmitHandler}>
          {errors.server && (
          ...
          <div className="space-y-1">
            ...
            <div className="relative mt-1 rounded-md shadow-sm">
              ...
              <input
                ...
                className={`block w-full pl-10 pr-3 py-2 border ${errors.username ? 'border-red-300' : 'border-gray-300'} rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm`}
          ...
          <div className="space-y-1">
            ...
            <div className="relative mt-1 rounded-md shadow-sm">
              ...
              <input
                ...
                onChange={onChangeHandler}
                className={`block w-full pl-10 pr-3 py-2 border ${errors.confirm_password ? 'border-red-300' : 'border-gray-300'} rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm`}
                placeholder="••••••••"
              />
            </div>
          ...
          <div className="space-y-1">
            ...
            <div className="relative mt-1 rounded-md shadow-sm">
              ...
              <input
                ...
                onChange={onChangeHandler}
                className={`block w-full pl-10 pr-3 py-2 border ${errors.whatsappNumber ? 'border-red-300' : 'border-gray-300'} rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm`}
          ...
          <div className="space-y-1">
            ...
            <select
              name="role"
              id="role"
              className={`mt-1 block w-full pl-3 pr-10 py-2 border ${errors.role ? 'border-red-300' : 'border-gray-300'} rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm`}
              onChange={onChangeHandler}
              value={userData.role}
            >
              <option value="student">Student / Job Seeker</option>
              <option value="employee">Employer / Recruiter</option>
            </select>
